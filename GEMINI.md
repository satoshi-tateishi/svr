...
## 0. 基本方針
- **動作環境**: 本アプリケーションは Docker 環境 for 動作します。開発・テスト・実行は Docker コンテナ内で行うことを前提とします。
...
## 1. プロジェクト概要
演劇制作におけるスタッフ配置、車輌配車、および標準工程（1〜10工程）を一元管理する Django ベースのシステム。
...
## 4. 主要機能要件
1. **工程テンプレート展開**: 公演に対して標準 10 工程を冪等性を保ちつつ一括生成。
