...
class Location(models.Model):
    ...
    furigana = models.CharField(max_length=200, blank=True, default='', verbose_name='ふりがな')
    postal_code = models.CharField(max_length=10, blank=True, default='', verbose_name='郵便番号')
    address = models.CharField(max_length=255, blank=True, default='', verbose_name='住所')
