...
urlpatterns = [
    ...
    path(
        ...
        views.vehicle_operation_delete,
        name='vehicle_operation_delete',
    ),
    path(
        '<int:pk>/vehicles/batch-delete/',
        views.vehicle_operation_batch_delete,
        name='vehicle_operation_batch_delete',
    ),
